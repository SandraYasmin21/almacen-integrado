...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Algunas instalaciones ya ejecutaron una version anterior de la
        // migracion base que aun no incluia el modulo de proyectos.
        if (! Schema::hasTable('proyectos_presupuestos')) {
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('proyectos_presupuestos')) {
            Schema::table('proyectos_presupuestos', function (Blueprint $table) {
                foreach (['observaciones', 'estatus', 'fecha_cierre_estimada', 'fecha_inicio', 'responsable_id', 'cliente_nombre'] as $column) {
