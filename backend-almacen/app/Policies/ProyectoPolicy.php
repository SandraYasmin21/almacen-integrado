...
class ProyectoPolicy
{
    ...
    public function create(Usuario $user): bool { return $this->any($user, Usuario::ROL_ALMACEN, Usuario::ROL_PROYECTO); }
    public function update(Usuario $user): bool { return $this->any($user, Usuario::ROL_ALMACEN, Usuario::ROL_PROYECTO); }
