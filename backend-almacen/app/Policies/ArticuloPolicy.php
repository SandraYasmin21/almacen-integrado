...
class ArticuloPolicy
{
    ...
    {
        return $this->any($user, Usuario::ROL_ALMACEN, Usuario::ROL_PROYECTO, Usuario::ROL_SOLICITANTE, Usuario::ROL_DIRECCION);
    }
    ...
    {
        return $this->any($user, Usuario::ROL_ALMACEN);
    }
    ...
    {
        return $this->any($user, Usuario::ROL_ALMACEN, Usuario::ROL_DIRECCION);
    }
}
